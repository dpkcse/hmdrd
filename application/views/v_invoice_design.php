...
function printDiv(divName) {
    ...
    var popupWin = window.open('', '_blank', 'width=1366,height=768,location=no,left=200px');

    popupWin.document.open();

    popupWin.document.write('<html><title>::Preview::</title><link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>Assets/dist/css/adminlte.min.css" /><link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>Assets/plugins/datatables/dataTables.bootstrap4.css" /><link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>Assets/css/custom.css" /></head><body onload="window.print()">');
