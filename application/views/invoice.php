            ...
            <div class="container-fluid" style="background-color: #FFF">
                <div class="box">
                    ...
                    <div class="row">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>ঠিকানা ঃ</td>
                                        <td>
                                            <select class="form-control inpSelect" name="" id="pharmacyAddress"  required>
                                                <option value="" selected disabled>Select One</option>
                                            </select>
                                        </td>
                                        ...
                                        <td>
                                            <select class="form-control inpSelect" name="stuffid" id="salesMan"  required>
                                                <option value="" selected disabled>Select One</option>
                        ...
                        <div class="col-md-4 col-lg-4" style="margin:35px 0">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>                                
                                        <td style="width: 12%">মোট টাকা ঃ</td>
                                        <td style="width: 30%">
                                            <input type="text" class="form-control" name="totaltk" id="totaltk"  required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>কমিশন ঃ</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 30%">
                                            <input type="text" class="form-control" name="paid" id=""  required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>পাত্তনা ঃ</td>
...
function appendNewRow(elm) {
    ...
    var html = '<tr class="eachRow">'+
                '    <td class="code_no">'+
                '       <select class="form-control inpSelect code_select" id="code_no_'+_uniqueRow_id+'" name="productcode[]" style="width:100%;" onchange="getProductDetailsByCode(this)" autofocus >'+
    ...
    $.ajax({
       ...
       success: function (res) {
           if (res) {
            ...
            // var totalAmount = 0;
            // $.each($('.total_price'), function (k,v) {
            //     totalAmount = parseInt(totalAmount)+ parseInt($(v).text());
            // });
...
function multiplyQty(e) {
    ...
    if (code == 13) {
        ...
        if ($(e.target).val() != '') {
            ...
            var totalAmount = 0;
            $.each($('.total_price'), function (k,v) {
                totalAmount = parseInt(totalAmount)+ parseInt(converBn2En($(v).text()));
            });
