                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <?php foreach ($customers as $row2){ ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url('public/edit-c/'.$row2['id']);?>" class="btn btn-outline-info btn-sm">Edit</a> <a href="<?php echo base_url('public/del-c/'.$row2['id']);?>" class="btn btn-outline-danger btn-sm">Delete</a></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
