...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2019 at 05:43 PM
...
INSERT INTO `hmdrd_employees` (`username`, `password`, `person_id`, `deleted`, `hash_version`, `language`, `language_code`) VALUES
('dpkcse', 'asdasdqweqweasdasdasdasd', 12, 0, 2, NULL, NULL);
...
INSERT INTO `hmdrd_people` (`first_name`, `last_name`, `gender`, `phone_number`, `email`, `address_1`, `address_2`, `city`, `state`, `zip`, `country`, `comments`, `person_id`) VALUES
('আজাদ', '', 1, '01254', 'dipokchakraborty@gmail.com', '', '', '', '', '1212', 'Bangladesh', '', 12);
...
CREATE TABLE `hmdrd_sales` (
  ...
  `sales_paid` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `hmdrd_sales` (`sale_time`, `customer_id`, `employee_id`, `comment`, `invoice_number`, `quote_number`, `sale_id`, `sale_status`, `dinner_table_id`, `work_order_number`, `sale_type`, `sales_paid`) VALUES
('2019-07-13 18:00:00', 1, 12, NULL, '#invoice_321644', NULL, 3, 0, NULL, NULL, 0, NULL),
('2019-07-13 18:00:00', 1, 12, NULL, '#invoice_275373', NULL, 4, 0, NULL, NULL, 0, NULL),
('2019-07-13 18:00:00', 2, 12, NULL, '#invoice_694415', NULL, 5, 0, NULL, NULL, 0, '120');
...
--
-- Dumping data for table `hmdrd_sales_items`
--

INSERT INTO `hmdrd_sales_items` (`sale_id`, `item_id`, `description`, `serialnumber`, `line`, `quantity_purchased`, `item_cost_price`, `item_unit_price`, `discount_percent`) VALUES
(5, 4, NULL, '0', 0, '12.000', '0.00', '210.00', '0.00'),
(5, 6, NULL, '1', 0, '21.000', '0.00', '109.00', '0.00');
...
--
ALTER TABLE `hmdrd_sales_items`
  ADD CONSTRAINT `hmdrd_sales_items_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `hmdrd_sales_items_ibfk_2` FOREIGN KEY (`sale_id`) REFERENCES `hmdrd_sales` (`sale_id`) ON DELETE CASCADE ON UPDATE CASCADE;
